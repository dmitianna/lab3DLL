...
Также реализованы проверки ошибок всех основных этапов инъекции.
...
* Создание удалённого потока выполняется успешно.
* Загрузка DLL блокируется политикой безопасности.
* MessageBox «BOOM!» не появляется.
* Windows отображает сообщение об ошибке загрузки DLL.
